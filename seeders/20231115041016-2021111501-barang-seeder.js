...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.bulkInsert('Barangs', [
      ...
      { nama: 'Teh', stok: 100, jumlahTerjual: 0, jenisBarang: 'Konsumsi', createdAt: new Date(), updatedAt: new Date() },
      ...
      { nama: 'Teh', stok: 81, jumlahTerjual: 0, jenisBarang: 'Konsumsi', createdAt: new Date(), updatedAt: new Date() },
    ], {});
  },
